...
PREFIX = os.path.join(staticfiles_settings.ROOT[len(settings.MEDIA_ROOT):], "jquery")
...
jquery_slider = Bundle(
    os.path.join(PREFIX, 'slider/jquery.slider.js'),                                    
    output="gen/jquery.slider.js",                
)

jquery_slider_css = Bundle(
    os.path.join(PREFIX, 'slider/styles/style.css'),                                    
    output="gen/jquery.slider.css",                
)